...
\begin{align}
    F(X,Y,Z,W)=\sum(0,1,2,3,5,6,7,10,14,15)
\end{align}
\section{SOLUTION}
From the K-Map shown in Figure \ref{fig:kmap} the above expression can be simplified as,
\begin{figure}[!ht]
\centering
